...
test.describe('First exercise - three buttons', () => {
  test('Happy path - we follow the trail', { 
    tag: '@happy' 
      ...
      await page.goto(`/exercises/exercise1`);
      ...
      console.log(buttonsToClickLabels);
      ...
      // const hashRow = footer.locator('xpath=following-sibling::div[contains(@class, "row")][1]');
      // console.log(seed.innerText);
